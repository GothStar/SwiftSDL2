...
public final class Surface {
    var cSurfacePtr: UnsafeMutablePointer<SDL_Surface>
...
extension Surface {
    ...
    /// Initizing Surface by SDL2_image library
    public convenience init(image filename: String) throws {
        
        guard let ptr = IMG_Load(filename) else {
            throw SDLError()
        }
        self.init(cSurfacePtr: ptr)
        self.cSurfacePtr = ptr
        self.freeWhenDone = true
    }
}
